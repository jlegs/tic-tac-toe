...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tic_tac_toe_tile', 'computer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='computer_moves', null=True, to=orm['tic_tac_toe.Computer']),
                      keep_default=False)
    ...
    models = {
        ...
        'tic_tac_toe.tile': {
            ...
            'computer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'computer_moves'", 'null': 'True', 'to': "orm['tic_tac_toe.Computer']"}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'tiles'", 'null': 'True', 'to': "orm['tic_tac_toe.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'player_moves'", 'null': 'True', 'to': "orm['tic_tac_toe.Player']"}),
